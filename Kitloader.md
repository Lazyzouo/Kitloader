...
| --- | --- | --- |
| `Kitloader-2.0.8-en.us.jar` | `en_US` | English servers |
| `Kitloader-2.0.8-zh.cn.jar` | `zh_CN` | Simplified Chinese servers |
...
| 包 | 默认 `language` | 面向服务器 |
| --- | --- | --- |
| `Kitloader-2.0.8-en.us.jar` | `en_US` | 英文服务器 |
| `Kitloader-2.0.8-zh.cn.jar` | `zh_CN` | 简体中文服务器 |
